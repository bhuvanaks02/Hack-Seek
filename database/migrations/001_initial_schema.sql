...
-- Description: Create initial database schema for HackSeek
-- Date: 2025-01-01
-- Author: HackSeek Team

-- This migration creates the foundational tables and indexes
-- for the HackSeek hackathon discovery platform.
